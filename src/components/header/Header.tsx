...
const Header: React.FC<HeaderProps> = ({  }) => {
  ...
  return (
    <header className="mt-2 sticky top-0 z-[999999] flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-4 xl: py-4">
